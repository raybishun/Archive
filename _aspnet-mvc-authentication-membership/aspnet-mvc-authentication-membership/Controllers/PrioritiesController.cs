...
namespace aspnet_mvc_authentication_membership.Controllers
{
    public class PrioritiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PriorityId,PriorityDesc")] Priority priority)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PriorityId,PriorityDesc")] Priority priority)
        {
            if (ModelState.IsValid)
            {
